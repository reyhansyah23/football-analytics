...
class PremierLeagueScraper:
    ...
    def get_teams(self):
        ...
        try:
            ...
            print(f"Success loading teams in season {self.season}")
    ...
    def get_all_squads(self):
        ...
        for t_id in team_ids:
            print(f"Fetching Squad for Team ID: {t_id} in season {self.season}...")
        ...
        print(f"Success loading squads in season {self.season}")
    ...
    def get_matches(self, matchweeks=1):
        ...
        for mw in range(1, matchweeks + 1):
            print(f"Fetching Matchweek {mw} for season {self.season}...")
...
if __name__ == "__main__":
    ...
    scraper.get_matches(matchweeks=2)